...
- feature -> dev 기준 PR 템플릿 자동 작성 및 생성 준비

### 원문

- PR 템플릿에 맞게 자동 작성해서 올려줄 수 있나? 지금 feature 브랜치에서 일단 dev 브랜치로

### 결과 요약

- PR 템플릿 기반 자동 본문 생성
- feature 브랜치 변경분 push 및 PR 생성 링크 제공

## 2026-03-22

### 목적

- 생성된 PR에 메타데이터(라벨/리뷰어/담당자) 자동 반영
